    ...
    policy: {
      ...
      sections: [
          ...
          blocks: [
            ...
            },
            {
              ...
              items: [
                ...
                "마지막으로 선택한 프레임",
                "일부 기능 안내의 확인 여부",
                "구매 권한 확인·복원 및 중복 거래 처리 방지에 필요한 정보(7절 참조)",
              ],
            },
            {
              type: "paragraph",
        ...
        },
        {
          title: "3. 사진 접근 권한",
          paragraphs: [
            "사진을 불러올 때는 iOS 시스템 사진 선택기를 사용하며, 이용자가 직접 선택한 사진만 편집에 사용합니다. 이 과정에서 사진 보관함 전체에 대한 접근 권한을 미리 요청하지 않습니다.",
            "완성한 사진을 저장할 때는 사진 앱에 사진을 추가하기 위한 권한을 요청합니다. 이 권한으로 기존 사진 보관함 전체를 읽지 않습니다. 권한을 허용하지 않으면 사진 앱 저장을 진행하지 않으며, 이용자는 기기 설정에서 권한을 변경할 수 있습니다.",
          ],
        },
        {
          ...
          paragraphs: [
            ...
            "촬영, 사진 불러오기, 편집 및 공유 과정에서 앱 전용 저장공간에 임시 이미지 사본이 생성될 수 있습니다. 앱은 편집 취소, 저장 완료 등 해당 사본이 더 이상 필요하지 않은 시점에 정리합니다. 저장 실패 후 재시도에 필요한 사본은 유지하며, 비정상 종료나 삭제 실패로 남은 사본은 다음 앱 실행 시 정리를 시도합니다. 이 과정에서 이용자의 사진 앱에 있는 원본 사진은 삭제하지 않습니다.",
        ...
        },
        {
          ...
          blocks: [
            ...
            {
              type: "paragraph",
              text: "문의하기를 선택하면 앱 버전·빌드 번호, 운영체제·버전, 기기 제조사·모델명과 앱 언어가 입력된 메일 초안이 열립니다. 이용자는 내용을 확인하거나 수정할 수 있으며, 메일 앱에서 직접 보내기를 선택한 경우에만 개발자에게 전달됩니다. 사진·기기 고유 식별자·위치정보를 초안에 자동 첨부하지 않습니다.",
            },
            {
              type: "paragraph",
        ...
        },
        {
          ...
          blocks: [
            ...
            { type: "subheading", text: "앱 내 구매" },
            {
              type: "paragraph",
              text: "Apple App Store가 결제를 처리하며, 개발자는 결제 카드 정보나 Apple 계정 인증정보를 직접 수집하거나 저장하지 않습니다. 앱은 구매 권한 확인·복원 및 중복 거래 처리 방지를 위해 상품 식별자, 거래 식별자, 검증 시각 및 제한된 처리 완료 거래 식별자 목록을 기기에 보관합니다. 이 정보는 개발자 서버로 전송되지 않으며, 구매와 복원 등 필요한 처리는 Apple StoreKit을 통해 이루어집니다.",
            },
          ],
        },
        {
          ...
          paragraphs: [
            ...
            "앱에 저장된 구매 확인용 데이터와 Apple이 관리하는 구매 내역은 별개입니다. 앱을 삭제해도 Apple이 관리하는 구매 내역은 삭제되지 않으며, 해당 정보의 처리는 Apple의 정책을 따릅니다.",
